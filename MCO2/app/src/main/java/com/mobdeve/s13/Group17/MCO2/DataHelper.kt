...
class DataHelper {
    companion object {
          ...
          //  lateinit var dbf : FirebaseFirestore
            ...
            data.add(
                Books(
                    ...
                    "Suzanne Collins",
                    "In the ruins of a place lies the nation of Panem, a shining Capitol surrounded by twelve outlying districts. The Capitol is harsh and cruel and keeps the districts in line by forcing them all to send one boy and one girl between the ages of twelve and eighteen to participate in the annual Hunger Games, a fight to the death on live TV.\n" +
                            "\n" +
                            "Katniss steps forward to take her sister's place in the Games. " +
        ...
        fun initializedData(): ArrayList<BookReview>{
          ...
          data.add(
                BookReview("Divergent", "Veronica Roth","Divergent follows the story of Beatrice (Tris), who has a " +
                        ...
                        3.0F,"This book is so interesting. It didn't disappoint me", R.drawable.divergent, "October 20, 2022")
            )
            data.add(
                BookReview("Harry Potter", "J.K. Rowling","The novels follow Harry Potter, " +
                        ...
                        "books with the same plot. I totally love it. Would recommend it to my friends",R.drawable.harry, "January 10, 2023")
            )
            data.add(
                BookReview("Hunger Games", "Suzanne Collins","The Hunger Games is an annual event in which one boy and one girl aged " +
                        ...
                        R.drawable.hunger_games, "June 15, 2021")
            )
        ...
        fun initializeDatum(): ArrayList<Comment>{
            ...
            data.add(
                Comment("jasminchua", "will recommend this to all of my book lover friends")
            )
            data.add(
                Comment("hailytan", "worth my time and money")
            )
