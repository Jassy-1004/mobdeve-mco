...
class BookInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.addbtnFab.setOnClickListener {
            ...
            intent.putExtra(AddBookReview.BOOK_TITLE_KEY, viewBinding.booktitletv.toString())
            intent.putExtra(AddBookReview.AUTHOR_KEY, viewBinding.authortv.toString())
            intent.putExtra(AddBookReview.DESCRIPTION_KEY, viewBinding.descriptiontv.toString())
            intent.putExtra(AddBookReview.POSITION_KEY, position)
